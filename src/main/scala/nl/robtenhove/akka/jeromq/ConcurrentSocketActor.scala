...
private[jeromq] object ConcurrentSocketActor {
...
private[jeromq] class ConcurrentSocketActor(params: immutable.Seq[SocketOption], zmqContext: Context) extends Actor {

  import nl.robtenhove.akka.jeromq.ConcurrentSocketActor._
  ...
  private val socketType = {
    import nl.robtenhove.akka.jeromq.SocketType.{ZMQSocketType => ST}
  ...
  override def preStart {
    ...
    import nl.robtenhove.akka.jeromq.SocketType._
    socketType match {
